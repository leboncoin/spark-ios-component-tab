//
//  TabSegmentViewModelDeprecatedTests.swift
...
final class TabSegmentViewModelDeprecatedTests: XCTestCase {

    // MARK: - Private properties
    private var theme: ThemeGeneratedMock!
    private var tabGetStateAttributesUseCase: TabGetStateAttributesUseCasableDeprecatedGeneratedMock!
    ...
    override func setUp() {
        ...
        tabGetStateAttributesUseCase = TabGetStateAttributesUseCasableDeprecatedGeneratedMock()
        ...
        tabGetStateAttributesUseCase.executeWithThemeAndIntentAndStateAndTabSizeAndHasTitleReturnValue = TabStateAttributesDeprecated(
    ...
    func test_usecase_is_executed_on_initialization() {
        ...
        XCTAssertEqual(arguments?.state, TabStateDeprecated(), "sut state should be TabState that has default parameters")
    }
    ...
    func test_published_attributes_on_initialization() {
        ...
        let expectedAttributes = TabStateAttributesDeprecated(
            spacings: self.spacings,
            colors: self.colors,
            heights: expectedHeights,
        ...
        var givenAttributes: TabStateAttributesDeprecated?
...
// MARK: - Helper
private extension TabSegmentViewModelDeprecatedTests {
