...
final class TabViewModelDeprecated<Content>: ObservableObject {

    // MARK: - Private variables
    private var useCase: any TabsGetAttributesUseCaseableDeprecated
    ...
    @Published var tabsAttributes: TabsAttributesDeprecated
    ...
    init(theme: any Theme,
         ...
         content: [Content],
         tabSize: TabSize,
         useCase: any TabsGetAttributesUseCaseableDeprecated = TabsGetAttributesUseCaseDeprecated()
    ) {
        self.theme = theme
