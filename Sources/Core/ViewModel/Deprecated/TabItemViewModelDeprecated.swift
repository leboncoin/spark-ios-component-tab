//
//  TabSegmentViewModelDeprecated.swift
//  SparkComponentTab
//
...
/// `TabSegmentViewModelDeprecated` is the view model for both the SwiftUI `TabItemView` as well as the UIKit `TabItemUIView`.
...
final class TabSegmentViewModelDeprecated<Content>: ObservableObject where Content: TitleContaining {

    // MARK: - Private Properties
    private var tabState: TabStateDeprecated {
        didSet {
    ...
    private let tabGetStateAttributesUseCase: TabGetStateAttributesUseCasableDeprecated
    ...
    @Published var tabStateAttributes: TabStateAttributesDeprecated
    ...
    init(
        ...
        tabGetStateAttributesUseCase: TabGetStateAttributesUseCasableDeprecated = TabGetStateAttributesUseCaseDeprecated()
    ) {
