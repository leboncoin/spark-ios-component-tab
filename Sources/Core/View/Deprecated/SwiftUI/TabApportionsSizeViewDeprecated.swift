//
//  TabApportionsSizeViewDeprecated.swift
//  SparkComponentTab
//
...
/// TabApportionsSizeViewDeprecated is the similar to a SegmentControl with apportionsSegmentWidthsByContent == true.
struct TabApportionsSizeViewDeprecated: View {
    private let intent: TabIntent

    @ObservedObject private var viewModel: TabViewModelDeprecated<TabItemContent>
    ...
    init(viewModel: TabViewModelDeprecated<TabItemContent>,
                intent: TabIntent,
