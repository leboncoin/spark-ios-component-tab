...
struct TabItemViewDeprecated: View {

    // MARK: - Private Variables
    @ObservedObject private var viewModel: TabSegmentViewModelDeprecated<TabItemContent>
    ...
    init(
        viewModel: TabSegmentViewModelDeprecated<TabItemContent>,
